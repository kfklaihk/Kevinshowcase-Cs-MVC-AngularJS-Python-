...
namespace WebApplication1
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
...

        {
            ...
            public bool RequireUniqueuserid { get; set; }
            ...
            public override async Task<IdentityResult> ValidateAsync(ApplicationUser user)
            {
                ...
                var errors = result.Errors.ToList();
                    ...
                    {
                        errors.Add("Require non empty and unique userid");
                    result = new IdentityResult(errors);
                    return result;
                    }
                  var owner = Manager.Users.FirstOrDefault(x => x.userid == user.userid);
                if (owner != null && owner.Id != user.Id)
                {
                    errors.Add("userid " + user.userid +" is already taken");
                    result = new IdentityResult(errors);
                }
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
         ...
         /*   manager.UserValidator = new UserValidator<ApplicationUser>(manager)
            ...
            */
            ...
            { AllowOnlyAlphanumericUserNames = false, RequireUniqueEmail = true, RequireUniqueuserid=true };
